...
\begin{itemize}
	...
	\item La aplicación permitirá al usuario, ingresar por teclado el mensaje que desea mostrar mediante los caracteres que se establecen en el estándar (ver \cite{CodifChar}).
	\item El sistema (cartel) deberá ser capaz de aceptar sólo conexiones por TSL de forma que las conexiones y el intercambio de paquetes sea cifrado y seguro.
